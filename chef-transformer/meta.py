...
<span class="d-block extra-info">(We are at your service with two of the best chefs in the world: Chef A, 
Chef B. Chef A is known for being more creative whereas Chef B is more meticulous.)</span>
</p>
""".strip()
